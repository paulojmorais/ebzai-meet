...
@section('container')
    <form method="post" action="{{ route('LaravelInstaller::verify') }}" class="tabs-wrap">
      ...
      <div class="form-group">
        ...
        <input type="text" name="code" placeholder="Envato Purchase Code" value="{{ session('code') }}" required>
      ...
      <div class="form-group">
        ...
        <input type="text" name="email" placeholder="Admin Email" value="{{ session('email') }}" required>
      </div>
      <div class="form-group">
